...
Data is stored on the persistent disk at /data/oxigraph.db (Oxigraph directory store).
...
_DB_PATH = os.path.join(_DATA_DIR, "oxigraph.db")
_STORE_PATH = os.path.join(_DATA_DIR, "rdf_structure_store")
